...
/** This class represents the response containing the embedded editor link for a document. */
@JsonIgnoreProperties(ignoreUnknown = true)
public class DocumentEmbeddedEditorLinkPostResponse {
  ...
  /**
   * Constructs a new DocumentEmbeddedEditorLinkPostResponse with the specified data URL.
   *
   * @param data the link for document editor inside 'data' object.
   */
  @JsonCreator
  public DocumentEmbeddedEditorLinkPostResponse(@JsonProperty("data") DataUrl data) {
    this.data = data;
  }
