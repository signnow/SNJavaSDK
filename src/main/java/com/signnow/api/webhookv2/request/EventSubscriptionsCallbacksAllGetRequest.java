...
/**
 * This class represents a request to get all event subscriptions callbacks.
...
public final class EventSubscriptionsCallbacksAllGetRequest implements RequestInterface<String> {
   ...
   *
   * @return HashMap&lt;String, String&gt; - an empty HashMap of URI parameters.
   */
  @NotNull
   ...
   *
   * @return Map&lt;String, String&gt; - an empty HashMap of payload.
   */
  @NotNull
  @Override
