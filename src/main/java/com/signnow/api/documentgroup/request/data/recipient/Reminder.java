...
/**
 * Represents a reminder with specific time intervals.
 */
...
public final class Reminder extends ApiData {
    ...
    /**
     * Converts the reminder data to a map.
     *
     * @return a map representation of the reminder data
     */
    @NotNull
    @Override
    ...
    /**
     * Creates a Reminder instance from a map.
     *
     * @param data the map containing reminder data
