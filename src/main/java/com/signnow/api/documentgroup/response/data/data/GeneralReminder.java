...
/**
 * GeneralReminder class extends ApiData.
 * It represents the general reminder data in the document group recipients response.
 */
...
public final class GeneralReminder extends ApiData {
  ...
  /**
   * Constructor for GeneralReminder class.
   *
  ...
  /**
   * Converts the GeneralReminder object to a Map.
   *
   * @return A map representation of the GeneralReminder object.
   */
  @NotNull
  @Override
  ...
  /**
   * Creates a GeneralReminder object from a Map.
   *
   * @param data The map containing the general reminder data.
   * @return A new GeneralReminder object.
   */
  @NotNull
  @Contract("_ -> new")
